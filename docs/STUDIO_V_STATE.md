...
- `2bd6545` depth-v22: removed the `Core systems` and `Production network` labels so
  partner hierarchy is carried by mark scale; preserved the black base and soft-field
  layer. Rollback baseline remains `aae3b53`.
